...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-automation-connectors-livewire?sort=semver)](https://github.com/liberusoftware/module-automation-connectors-livewire/releases/latest) [![Tests](https://github.com/liberusoftware/module-automation-connectors-livewire/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-automation-connectors-livewire/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-automation-connectors-livewire
```
...
<a href="https://github.com/liberusoftware/module-automation-connectors-livewire/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-automation-connectors-livewire" alt="Contributors to liberusoftware/module-automation-connectors-livewire">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-automation-connectors-livewire/graphs/contributors).
